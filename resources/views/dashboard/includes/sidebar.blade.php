            ...
            <li class="nav-item"><a href="{{ route('admin.products.index') }}"><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.products.index') }}"
                                          data-i18n="nav.dash.ecommerce">{{ __('admin/products.show_all_products') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('admin.products.create') }}" data-i18n="nav.dash.crypto">
                            {{ __('admin/products.add_new_product') }}  </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href="{{ route('admin.options.index') }}"><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.options.index') }}"
                                            data-i18n="nav.dash.ecommerce">{{ __('admin/options.show_all_options') }}</a>
                    </li>
                    <li><a class="menu-item" href="{{ route('admin.options.create') }}" data-i18n="nav.dash.crypto">
                            {{ __('admin/options.add_new_option') }}  </a>
                    </li>
                </ul>
            </li>
