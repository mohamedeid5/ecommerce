                    ...
                    <div class="col-md-6">
                        ...
                        <form method="post" action="{{ route('admin.profile.edit') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="key" value="{{ old('name', $admin->name) }}" aria-describedby="key" placeholder="name">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" value="{{ old('email', $admin->email) }}" id="exampleInputPassword1" placeholder="email">
                            </div>
                            @error('email')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
